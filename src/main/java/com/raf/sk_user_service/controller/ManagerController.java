...
public class ManagerController {
    ...
    public ResponseEntity<ManagerDto> add(@RequestBody ManagerCreateDto managerCreateDto){
        ...
        jmsTemplate.convertAndSend(orderDestination,
                messageHelper.createTextMessage(new NotiDto(managerCreateDto.getEmail(), "REGISTER_TYPE", tmp.getId())));
    ...
    public ResponseEntity<String> findEmail(@PathVariable("id") Long id){
        return new ResponseEntity<>(managerRepository.findManagerById(id).getEmail(), HttpStatus.OK);
    }
